#ifndef GAME_CORE_VIEW_CONSOLEVIEW_CONSOLEFIELDVIEWTAB_H_
#define GAME_CORE_VIEW_CONSOLEVIEW_CONSOLEFIELDVIEWTAB_H_
...
#endif //GAME_CORE_VIEW_CONSOLEVIEW_CONSOLEFIELDVIEWTAB_H_