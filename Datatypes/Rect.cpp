...
int Rect::width() const { return bottom_right.x - top_left.x; }

int Rect::height() const { return bottom_right.y - top_left.y; }

int Rect::top() const { return top_left.y; }

int Rect::right() const { return bottom_right.x; }

int Rect::bottom() const { return bottom_right.y; }

int Rect::left() const { return top_left.x; }
